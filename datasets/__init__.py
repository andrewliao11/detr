...
def build_dataset(image_set, dataset_args, given_class_mapping=None):
    ...
    elif dataset_args.name in ["synscapes_car", "synscapes"]:
    ...
    elif dataset_args.name in ["cityscapes_car", "cityscapes"]:
    ...
    elif dataset_args.name in ["mixed_cityscapes_car_synscapes_car"]:
